...
def QUANDL_price(tickers, start, end):
    """
    :param code: quandl code found on website
    :param start: datetime.date(yyyy, m, d)
    :param end: datetime.date(yyyy, m, d)
    :return: quandl dataframe
    """
...
def ShortInterest(code, start, end):
    """
...
def financials_download(ticker,report,frequency):
    """
    Ignore...for use with other formulae below
    """
...
def y_stats(symbol, stat):
    """
    Ignore...for use with other formulae
    """
...
def pensions_postretirement_benefits(ticker,frequency):
    ...
    """
    df = financials_download(ticker,'bs',frequency)
    return df.loc['Pensions and other postretirement benefits']
...
def other_longterm_liabilities(ticker,frequency):
    """
    :param ticker: e.g., 'AAPL' or MULTIPLE SECURITIES
    :param frequency: 'A' or 'Q' for annual or quarterly, respectively
    :return: obvious..
...
def operating_cash_flow_5yr(ticker,frequency):
    """
    :param ticker: e.g., 'AAPL' or MULTIPLE SECURITIES
    :param frequency: 'A' or 'Q' for annual or quarterly, respectively
    :return: obvious..
...
def capital_expenditure_5yr(ticker,frequency):
    """
    :param ticker: e.g., 'AAPL' or MULTIPLE SECURITIES
    :param frequency: 'A' or 'Q' for annual or quarterly, respectively
    :return: obvious..
...
def free_cash_flow_5yr(ticker,frequency):
    """
    :param ticker: e.g., 'AAPL' or MULTIPLE SECURITIES
    :param frequency: 'A' or 'Q' for annual or quarterly, respectively
    :return: obvious..
...
def capital_expenditure(ticker):
    df = ratios_download(ticker)
