...
def SP500():
    """
    Returns a list of stock tickers of constituents of S&P 500
    """
...
def financials_download(ticker, report, frequency):
    """
    Utility function for use with other financial formulae
    """
...
def ratios_download(ticker):
    """
    Use this to pull all available financial ratios for a security, from MorningStar
...
def y_stats(ticker, stat):
    """
    Utility function to pull in stock information from Yahoo Finance
