...
from Finance.GetData import QUANDL_price
...
def calc_portfolio_var(df, weights=None):
    """
    :param returns: daily percentage returns of portfolio of stocks
...
def index_returns(df, starting_value=0):
    ...
    :param returns: daily percentage returns of portfolio
...
def port_beta(df, spy):
    ...
    :param returns: daily pct returns of chosen securities
    :param market: daily pct returns of SPY
